...
class Home extends BaseController
{
    ...
    public function login()
    {
        ...
        $data['userdata_admin'] = $session->get("userdata_admin");

        if(isset($data['userdata_admin'])){
    ...
    public function searchMain(){
        $CityModel          = new CityModel();
        $data['cities']     = $CityModel->orderBy('position', 'ASC')->where('region', $this->request->getPost("region"))->findAll();
